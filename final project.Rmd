...
The casual inference between the self rated mental health and the workload should also be analyzed since 
as the above result shown, if people worked last week would decrease the rate of mental health, however, there were many factors may affect the trend, for example, between young people and old people, if they all worked last week adn the rate of the mental health increases, this could not tell any story, because old people tend to love their jobs more than younger people, they may be more resilient at work, and therefore have higher levels of mental health. Therefore, I chose to use `Difference-in-Difference`here to discover the casual inference between the self rated mental health and the workload, and then I got the graph below.
...
Then, we could find out what is the exact number which discribe the relationship between the `new_mental_health` and the `worked_last_week`.
```{r echo=FALSE, message=FALSE, warning=FALSE}
