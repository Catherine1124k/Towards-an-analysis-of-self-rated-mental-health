...
The result of the logistic regression model is shown in table 1 above.
...
The following figures showed how the probability of the Canadian felt good about their current life varies as the predictors(`age`, `feelings_life`, `self_rated_health` and `worked_last_week`).
